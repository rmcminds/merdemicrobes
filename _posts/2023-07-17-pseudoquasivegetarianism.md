...
For this one, I'll go over the details of my plant-based philosophy. I hope to edit this if my views change over time and if I find resources that influence my thinking or help to explain it. I don't plan to hide any changes - anything I don't write explicitly will be available by following changes to the blog post on GitHub ([here](https://github.com/rmcminds/merdemicrobes/commits/main/_posts/2023-07-17-pseudoquasivegetarianism.md)'s the whole history and [here](https://github.com/rmcminds/merdemicrobes/compare/08a5e531fb0bdd4a29d7b987c8b86d7565c37b81...main#diff-e1231061ed59440567949516d828248f44ac94e429729bb7393fa2aacc5263ca)'s and example comparing the first version to the latest).
